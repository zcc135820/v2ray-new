...
首先查看别人的 [youtube 教程](https://www.youtube.com/watch?v=xHZyDsFYdv)，了解怎么配置 v2ray-new**本项目使用最新 VLESS 协议，请在客户端配置选择 VLESS**。  
...
[![Deploy](https://www.herokucdn.com/deploy/butt.svg)](https://heroku.com/deploy)
